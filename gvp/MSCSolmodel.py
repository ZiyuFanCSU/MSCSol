...
class Model(torch.nn.Module):
    ...
    def __init__(self, node_in_dim, node_h_dim, 
        ...
        self.resnet18 = SKAnet.AFFresnext50_32x4d_zerobn()
    ...
    def forward(self, h_V, edge_index, h_E, seq,batch33,feature_molecule,picdata):
        ...
        resnet18= self.resnet18(torch.tensor(picdata,device=device, dtype=torch.float32))
        ...
        h_V = self.W_v(h_V) # to 100 16
        h_E = self.W_e(h_E) # to 32 1
