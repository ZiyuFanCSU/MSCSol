...
def Draw_3D(smiles,mol_id):
    mol = AllChem.MolFromSmiles(smiles)
    mol, _ = Compound3DKit.get_MMFF_atom_poses(mol, numConfs=10)
    Draw.MolToFile(mol,f'./img_3D/'+str(mol_id)+'.png', size=(224,224))
    mol = AllChem.AddHs(mol)
    Draw.MolToFile(mol,f'./img_3D_H/'+str(mol_id)+'.png', size=(224,224))
